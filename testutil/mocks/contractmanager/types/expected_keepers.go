...
import (
	...
	types0 "github.com/Nolus-Protocol/nolus-core/x/contractmanager/types"
...
func (m *MockContractManagerKeeper) AddContractFailure(ctx context.Context, address string, sudoPayload []byte, errMsg string) types0.Failure {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddContractFailure", ctx, address, sudoPayload, errMsg)
	ret0, _ := ret[0].(types0.Failure)
	return ret0
}
