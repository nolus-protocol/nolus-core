...
import (
	...
	appparams "gitlab-nomo.credissimo.net/nomo/nolus-core/app/params"
	"gitlab-nomo.credissimo.net/nomo/nolus-core/docs"
	"gitlab-nomo.credissimo.net/nomo/nolus-core/x/mint"
	mintkeeper "gitlab-nomo.credissimo.net/nomo/nolus-core/x/mint/keeper"
	minttypes "gitlab-nomo.credissimo.net/nomo/nolus-core/x/mint/types"
	"gitlab-nomo.credissimo.net/nomo/nolus-core/x/tax"
	taxmodulekeeper "gitlab-nomo.credissimo.net/nomo/nolus-core/x/tax/keeper"
	taxmoduletypes "gitlab-nomo.credissimo.net/nomo/nolus-core/x/tax/types"
...
func New(
	...
	interchainTxsIBCModule := interchaintxs.NewIBCModule(app.InterchainTxsKeeper)

	icaControllerIBCModule := icacontroller.NewIBCModule(app.ICAControllerKeeper, interchainTxsIBCModule)
