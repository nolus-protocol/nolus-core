...
const (
	Query_Params_FullMethodName  = "/nolus.feerefunder.Query/Params"
	Query_FeeInfo_FullMethodName = "/nolus.feerefunder.Query/FeeInfo"
)
...
func (c *queryClient) FeeInfo(ctx context.Context, in *FeeInfoRequest, opts ...grpc.CallOption) (*FeeInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_FeeInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) FeeInfo(context.Context, *FeeInfoRequest) (*FeeInfoResponse, error) {
