...
type Suspend struct {
	...
	S1Uspend    bool   `protobuf:"varint,2,opt,name=s1uspend,proto3" json:"s1uspend,omitempty"`
...
func (m *Suspend) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func (m *Suspend) GetS1Uspend() bool {
	if m != nil {
		return m.S1Uspend
	}
	return false
...
func (m *Suspend) GetBlockHeight() int64 {
	if m != nil {
...
func (m *Suspend) GetAdminKey() string {
	if m != nil {
		return m.AdminKey
	}
	return ""
...
func init() {
	proto.RegisterType((*Suspend)(nil), "nolus.suspend.v1beta1.Suspend")
}
...
var fileDescriptor_945d9845dee81bbf = []byte{
	...
	,
}
...
func (m *Suspend) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AdminKey) > 0 {
		...
		i = encodeVarintSuspend(dAtA, i, uint64(len(m.AdminKey)))
		i--
		dAtA[i] = 0x22
	}
	if m.BlockHeight != 0 {
	...
	if len(m.Creator) > 0 {
		...
		i = encodeVarintSuspend(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *Suspend) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field S1Uspend", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
