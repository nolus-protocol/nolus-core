...
const NOLUS_DENOM = "unls"
const ATOM_DENOM = "atom"
...
// CreateTestAccounts creates accounts and funds them with nolus and atom.
func (s *KeeperTestSuite) CreateTestAccounts(numAccs int) []TestAccount {
	...
	for i := 0; i < numAccs; i++ {
		...
		// fund account
		var coins sdk.Coins
		coins = coins.Add(sdk.NewInt64Coin(NOLUS_DENOM, 500))
		coins = coins.Add(sdk.NewInt64Coin(ATOM_DENOM, 300))
