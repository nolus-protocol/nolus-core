...
// AppModuleBasic implements the AppModuleBasic interface for the tax module.
...
// DefaultGenesis returns the tax module's default genesis state.
...
// RegisterRESTRoutes registers the tax module's REST service handlers.
...
// GetQueryCmd returns the tax module's root query command.
...
// AppModule implements the AppModule interface for the tax module.
...
// QuerierRoute returns the tax module's query routing key.
...
// RegisterInvariants registers the tax module's invariants.
func (am AppModule) RegisterInvariants(_ sdk.InvariantRegistry) {} // nolint: staticcheck // deprecated interface

// InitGenesis performs the tax module's genesis initialization It returns
...
// ExportGenesis returns the tax module's exported genesis state as raw JSON bytes.
