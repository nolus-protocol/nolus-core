...
// MsgOrigTransferHandler - 1) helps to bind `/nolus.transfer.Msg/Transfer` as a handler for `ibc.applications.transfer.v1.MsgTransfer`
// 2) converts `ibc.applications.transfer.v1.MsgTransfer` into nolus.transfer.MsgTransfer` before processing.
//
...
func MsgOrigTransferHandler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nolus.transfer.Msg/Transfer",
	}
