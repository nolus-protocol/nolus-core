...
// 	"github.com/Nolus-Protocol/nolus-core/x/interchainqueries/keeper"
// 	iqtypes "github.com/Nolus-Protocol/nolus-core/x/interchainqueries/types"
// )
...
// 				oldHeight, err := keeper.Keeper.LastRemoteHeight(*suite.GetNolusZoneApp(suite.ChainA).InterchainQueriesKeeper, ctx, &iqtypes.QueryLastRemoteHeight{ConnectionId: suite.TransferPath.EndpointA.ConnectionID})
...
// 					suite.NoError(suite.TransferPath.EndpointA.UpdateClient())
// 				}

// 				updatedHeight, err := keeper.Keeper.LastRemoteHeight(*suite.GetNolusZoneApp(suite.ChainA).InterchainQueriesKeeper, ctx, &iqtypes.QueryLastRemoteHeight{ConnectionId: suite.TransferPath.EndpointA.ConnectionID})
...
// 				q := q
// 				suite.NoError(suite.GetNolusZoneApp(suite.ChainA).InterchainQueriesKeeper.SaveQuery(suite.ChainA.GetContext(), &q))
// 			}

// 			resp, err := suite.GetNolusZoneApp(suite.ChainA).InterchainQueriesKeeper.RegisteredQueries(suite.ChainA.GetContext(), tt.req)
// 			suite.NoError(err)
...
// 	clientKey := host.FullClientStateKey(suite.TransferPath.EndpointB.ClientID)
// 	ctx := suite.ChainA.GetContext()
...
// 		Sender:   contractAddress.String(),
// 		ClientId: suite.TransferPath.EndpointA.ClientID,
...
// 	queryResultResponse, err := suite.GetNolusZoneApp(suite.ChainA).InterchainQueriesKeeper.QueryResult(ctx, &iqtypes.QueryRegisteredQueryResultRequest{
// 		QueryId: regQuery1.Id,
// 	})
// 	suite.NoError(err)
...
// 	_, err = suite.GetNolusZoneApp(suite.ChainA).InterchainQueriesKeeper.QueryResult(ctx, &iqtypes.QueryRegisteredQueryResultRequest{
