...
replace (
	...
	github.com/CosmWasm/wasmd => github.com/nolus-protocol/wasmd v0.61.1-nolus-2
	...
	github.com/cosmos/cosmos-sdk => github.com/nolus-protocol/cosmos-sdk v0.53.3-nolus-3
