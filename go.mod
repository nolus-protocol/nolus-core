...
replace (
	...
	github.com/CosmWasm/wasmd => github.com/nolus-protocol/wasmd v0.55.0-nolus
	...
	github.com/cosmos/cosmos-sdk => github.com/nolus-protocol/cosmos-sdk v0.53.0-nolus-2
