...
replace (
	cosmossdk.io/client/v2 => cosmossdk.io/client/v2 v2.0.0-beta.7
	// Cosmos/EVM need this replace to pick up the store changes (Copy func) in our cosmos-sdk branch
	...
	github.com/CosmWasm/wasmd => github.com/nolus-protocol/wasmd v0.54.0-nolus
